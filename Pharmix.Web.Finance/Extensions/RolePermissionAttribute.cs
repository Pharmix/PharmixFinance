...
namespace Pharmix.Web.Extensions
{
    ...
    public class RolePermissionFilter : IAuthorizationFilter
    {
        ...
        private void SetSkipPermissions()
        {
            ...
            //User Edit
            skipPermissions.Add("User_Edit", new List<string>() { "User_Get", "User_Save", "User_UserDepartments", "User_UpdateUserDepartments" });

            //User Roles
            skipPermissions.Add("User_Roles", new List<string>() { "User_SearchRole" });

            //for admin
            skipPermissions.Add("Patient_Index", new List<string>() {
                "Patient_Search",
                "Patient_Create",
                "Patient_Detail",
                "Patient_CommunicationNeed",
                "Patient_PlanOfCare",
                "Patient_MaternityContact",
                "Patient_MedicalHistory",
                "Patient_PrimaryCareContact",
                "Patient_NextOfKin",
                "Patient_EmergencyContact",
                "Patient_YourDetail",
                "Patient_PartnerDetail",
                "Patient_MentalHealth"
            });

            //for patient
            skipPermissions.Add("Patient_Detail", new List<string>() {
                "Patient_CommunicationNeed",
                "Patient_PlanOfCare",
                "Patient_MaternityContact",
                "Patient_MedicalHistory",
