...
namespace Pharmix.Web.Entities
{
    public interface IPharmixEntityContext
    {
        ...
        DbSet<PatientAppointment> PatientAppointments { get; set; }
        ...
        //Pregnancy Form2 Tables
        DbSet<YourDetail> YourDetail { get; set; }
        DbSet<PartnerDetail> PartnerDetail { get; set; }

        DbSet<EthnicOrigin> EthnicOrigin { get; set; }

        DbSet<Department> Departments { get; set; }
        DbSet<UserDepartment> UserDepartments { get; set; }

        //Pregnancy Form3 Tables
        DbSet<MedicalHistory> MedicalHistory { get; set; }
        DbSet<MentalHealth> MentalHealth { get; set; }

        //Customer Loans
        DbSet<Customer> Customers { get; set; }
        DbSet<DocumentType> DocumentTypes { get; set; }
        DbSet<Document> Documents { get; set; }
        DbSet<CustomerDocument> CustomerDocuments { get; set; }
        DbSet<Loan> Loans { get; set; }
        DbSet<LoanEMI> LoanEMIs { get; set; }
        DbSet<LoanDocument> LoanDocuments { get; set; }
    ...
    public class PharmixEntityContext : IdentityDbContext<ApplicationUser>, IPharmixEntityContext
    {
        ...
        //Pregnancy Form2 Tables
        public DbSet<YourDetail> YourDetail { get; set; }
        public DbSet<PartnerDetail> PartnerDetail { get; set; }

        public DbSet<EthnicOrigin> EthnicOrigin { get; set; }
        public DbSet<Department> Departments { get; set; }
        public DbSet<UserDepartment> UserDepartments { get; set; }

        //Pregnancy Form3 Tables
        public DbSet<MedicalHistory> MedicalHistory { get; set; }
        public DbSet<MentalHealth> MentalHealth { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Isolator>()
                .HasMany(ia => ia.StaffShiftAllocations);
            ...
            //Pregnancy Form2 Tables
            modelBuilder.Entity<YourDetail>().Property(e => e.Id).UseSqlServerIdentityColumn();
            modelBuilder.Entity<PartnerDetail>().Property(e => e.Id).UseSqlServerIdentityColumn();

            modelBuilder.Entity<EthnicOrigin>().Property(e => e.Id).UseSqlServerIdentityColumn();

            //Pregnancy Form3 Tables
            modelBuilder.Entity<MedicalHistory>().Property(e => e.Id).UseSqlServerIdentityColumn();
            modelBuilder.Entity<MentalHealth>().Property(e => e.Id).UseSqlServerIdentityColumn();
        }
