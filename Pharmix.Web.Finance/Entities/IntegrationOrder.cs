...
{
    [Table("IntegrationOrder", Schema = "INTG")]
    ...
    [Table("IntegrationOrderTracking", Schema = "INTG")]
    ...
    [Table("IntegrationOrderLocation", Schema = "INTG")]
    ...
    [Table("IntegrationOrderProgress", Schema = "INTG")]
    ...
    [Table("IntegratedSystem", Schema = "INTG")]
    ...
    [Table("IntegrationOrderClassification", Schema = "INTG")]
