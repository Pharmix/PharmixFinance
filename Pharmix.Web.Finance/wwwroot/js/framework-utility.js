...
(function ($, framework) {
    framework.UtilityService = function () {
        ...
        var executeAjaxRequestWithFile = function (actionUrl, actionData, successCallback, errorCallback, spinnerIntervalMs) {
            Framework.Spinner.Start(null, spinnerIntervalMs);
            $.ajax({
                processData: false,
                contentType: false,
        ...
        return {
            ...
            ExecuteAjaxRequestWithFile: function (actionUrl, actionData, successCallback, errorCallback, spinnerIntervalMs) {
                return executeAjaxRequestWithFile(actionUrl, actionData, successCallback, errorCallback, spinnerIntervalMs);
            }
        };
    }
