...
namespace Pharmix.Web.Migrations
{
    ...
    [Migration("20190905180437_CustomerEntityChages")]
    partial class CustomerEntityChages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("LocationOfBusiness")
                        .HasMaxLength(100);
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.CustomerContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.CustomerDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.Document", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.LoanDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.LoanEMI", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.Trust", b =>
                {
                    ...
                    b.Property<int>("AppointmentIntervalMins");
                    ...
                    b.Property<string>("FridayEndTiming")
                        .HasMaxLength(12);
                    ...
                    b.Property<string>("MondayEndTiming")
                        .HasMaxLength(12);
                    ...
                    b.Property<string>("SaturdayEndTiming")
                        .HasMaxLength(12);

                    b.Property<string>("SaturdayOpenTiming")
                        .HasMaxLength(12);

                    b.Property<string>("SundayEndTiming")
                        .HasMaxLength(12);

                    b.Property<string>("SundayOpenTiming")
                        .HasMaxLength(12);

                    b.Property<string>("ThursdayEndTiming")
                        .HasMaxLength(12);

                    b.Property<string>("ThursdayOpenTiming")
                        .HasMaxLength(12);

                    b.Property<string>("TuesdayEndTiming")
                        .HasMaxLength(12);
                    ...
                    b.Property<string>("WednesdayEndTiming")
                        .HasMaxLength(12);
            ...
            modelBuilder.Entity("Pharmix.Web.Entities.Department", b =>
                {
            ...
            modelBuilder.Entity("Pharmix.Web.Entities.UserDepartment", b =>
                {
                    ...
                    b.ToTable("UserDepartment","trusts");
                });
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.BankAccount", b =>
                {
                    b.HasOne("Pharmix.Data.Entities.Context.Customer", "Customer")
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.CustomerDocument", b =>
                {
                    ...
                    b.HasOne("Pharmix.Data.Entities.Context.Document", "Document")
                        .WithMany()
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.Document", b =>
                {
                    b.HasOne("Pharmix.Data.Entities.Context.DocumentType", "DocumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.Loan", b =>
                {
                    b.HasOne("Pharmix.Data.Entities.Context.BankAccount", "BankAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Pharmix.Data.Entities.Context.LoanDocument", b =>
                {
                    ...
                    b.HasOne("Pharmix.Data.Entities.Context.Loan", "Loan")
            ...
            modelBuilder.Entity("Pharmix.Web.Entities.PatientAppointment", b =>
                {
                    b.HasOne("Pharmix.Web.Entities.Department", "Department")
                        .WithMany()
