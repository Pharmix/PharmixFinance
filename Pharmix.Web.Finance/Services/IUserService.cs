...
namespace Pharmix.Web.Services
{
    public interface IUserService
    {
        ...
        UserDepartmentsViewModel CreateUserDepartmentsViewModel(int id, int trustId);
        BaseResultViewModel<string> UpdateUserDepartments(UserDepartmentsViewModel model, string user);
    }
}
