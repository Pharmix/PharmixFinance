...
namespace Pharmix.Web.Services
{
    public class LookupService : ILookupService
    {
        ...
        #region LoanStatus
        public List<KeyValuePair<string, string>> GetAllLoanStatus()
        {
            var loanStatusList = new List<KeyValuePair<string, string>>();
            foreach (var e in Enum.GetValues(typeof(LoanStatusEnum)))
            {
                loanStatusList.Add(new KeyValuePair<string, string>(e.ToString(), e.ToString()));
            }
