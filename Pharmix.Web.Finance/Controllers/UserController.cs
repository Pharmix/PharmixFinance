...
namespace Pharmix.Web.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        public async Task<JsonResult> Delete(int id)
        {
            ...
            return Json(new { StatusCode = StatusCodes.Status200OK, Message = "User removed successfully" });
        }
        ...
        public ViewResult ManageUserRole(int id)
        {
            string userId = _userService.GetUserIdByTempId(id);
            var user = _userService.GetUser(userId);
            ViewBag.ManageUserRoleSavedStatusMessage = TempData["ManageUserRoleSavedStatusMessage"] != null ? TempData["ManageUserRoleSavedStatusMessage"] : string.Empty;
        ...
        public async Task<ActionResult> ManageUserRole(UserViewModel userViewModel)
        {
            ...
            TempData["ManageUserRoleSavedStatusMessage"] = "Updated Successfully";
        ...
        public async Task<ViewResult> ManagePermission(int id)
        {
            ...
            ViewBag.ManagePermissionSavedStatusMessage = TempData["ManagePermissionSavedStatusMessage"];
        ...
        public async Task<ActionResult> ManagePermission(RoleViewModel roleViewModel)
        {
            ...
            TempData["ManagePermissionSavedStatusMessage"] = "Updated Successfully";
        ...
        public async Task<JsonResult> SetUserPassword(int id)
        {
            ...
            {
                NewPassword = newPwd,
                StatusCode = !string.IsNullOrEmpty(newPwd) ? StatusCodes.Status200OK : StatusCodes.Status500InternalServerError,
                Message = !string.IsNullOrEmpty(newPwd) ? "Password changed successfully" : "Password not updated. Please try again"
            });
        }
        ...
        #region Manage User Departments

        public IActionResult UserDepartments(int id)
        {
            var trustId = IsPharmixAdmin ? HttpContext.Session.GetInt32("TrustID") ?? 1 : _trustService.GetTrustIdByUser(CurrentUserName);
            var model = _userService.CreateUserDepartmentsViewModel(id, trustId);
            return PartialView("_UserDepartments", model);
        }
