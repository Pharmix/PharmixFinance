...
namespace Pharmix.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string returnUrl = null)
        {
            ...
            ViewBag.Message = Convert.ToString(TempData["LoginMessage"]);
            ...
            //{
            //    TrustList = new SelectList(trustService.GetAllTrusts()
        ...
        [AllowAnonymous]
        public async Task<ViewResult> ChangePassword(string userName)
        {
        ...
        public async Task<IActionResult> TempLogout()
        {
            await _signInManager.SignOutAsync();
            _logger.LogInformation("User logged out.");
            return RedirectToAction(nameof(HomeController.Index), "Home");
