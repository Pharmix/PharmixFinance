...
namespace Pharmix.Web.Models
{
    ...
    public class GridRow
    {
        ...
        public void AddCell(string cellValue, bool isLinkCell = false, string linkUrl = "#", bool isImage = false)
        {
            Cells.Add(new GridCell { CellValue = cellValue, IsLinkCell = isLinkCell, LinkUrl = linkUrl, IsImage = isImage });
        }
